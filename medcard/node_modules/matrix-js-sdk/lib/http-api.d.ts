...
export declare class MatrixHttpApi {
     ...
     */
    authedRequest<T, O extends IRequestOpts<T> = IRequestOpts<T>>(callback: Callback<T> | undefined, method: Method, path: string, queryParams?: Record<string, string | string[] | undefined>, data?: CoreOptions["body"], opts?: O | number): IAbortablePromise<ResponseType<T, O>>;
    /**
     ...
     * occurred. This includes network problems and Matrix-specific error JSON.
     */
    request<T, O extends IRequestOpts<T> = IRequestOpts<T>>(callback: Callback<T> | undefined, method: Method, path: string, queryParams?: CoreOptions["qs"], data?: CoreOptions["body"], opts?: O): IAbortablePromise<ResponseType<T, O>>;
    /**
     ...
     * occurred. This includes network problems and Matrix-specific error JSON.
     */
    requestOtherUrl<T, O extends IRequestOpts<T> = IRequestOpts<T>>(callback: Callback<T> | undefined, method: Method, uri: string, queryParams?: CoreOptions["qs"], data?: CoreOptions["body"], opts?: O | number): IAbortablePromise<ResponseType<T, O>>;
    /**
